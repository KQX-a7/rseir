...
rpyseir <- function()
{
  ...
  for (state_ac in state) 
  {
    ...
    initial_dd_parameter[5] <- as.integer(sampling_para$lockdown_date - reference_date)
    dd_parameter_upper[5] <- initial_dd_parameter[5]+opt_radius_of_policydate
    dd_parameter_lower[5] <- initial_dd_parameter[5]-opt_radius_of_policydate
    
    initial_dd_parameter[7] <- as.integer(sampling_para$reopen_date - reference_date)
    dd_parameter_upper[7] <- initial_dd_parameter[7]+opt_radius_of_policydate
    dd_parameter_lower[7] <- initial_dd_parameter[7]-opt_radius_of_policydate
    ###
...
state_info <- read_csv(glue("inputs/{country}_state_info.csv"), 
    col_types = cols(lock_down_date = col_date(format = "%Y/%m/%d"), 
        reopen_date = col_date(format = "%Y/%m/%d")))
...
dd_parameter_upper <- c(1,1,80,4.5,40,1.2,100,2,100,2)
