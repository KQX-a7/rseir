...
6.The observed dataset is "inputs/US_20200919_timeseries.csv", from https://github.com/covid-projections/covid-data-model/blob/master/data/timeseries.csv . To update it, download the csv file, rename it and place it on the given path.
...
{
  raw_timeseries <-
    read_csv("inputs/US_20200919_timeseries.csv", col_types = "cDcccciiiiiiiiiiiiii")
...
state_info <- read_csv("inputs/US_state_info.csv")
